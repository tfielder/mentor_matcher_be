...
In this repo, you will find the code and documentation for the Mentor Match back end, which provides the database and API endpoints for the Mentor Match Project and is deployed at https://mentor-matcher-turing-project.herokuapp.com/
...
Run locally:
1. Clone the repo found here: (https://github.com/tfielder/mentor_matcher_be)
...
All successful database requests return JSON in an easy-to-consume format generated by Netflix's [fast_jsonapi gem](https://github.com/Netflix/fast_jsonapi). To supply the Front End app with data, this project provides the following endpoints:
